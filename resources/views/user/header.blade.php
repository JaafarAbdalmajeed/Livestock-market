...
<header id="header" class="header  d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl m-3 d-flex align-items-center justify-content-between">
        <a href="/" class="logo d-flex align-items-center">
            <h1><img src="{{ asset('assets/img/3.jpg')}}"  width="90px" style="border-radius: 20%" class="img-fluid" style="width: 80px; height: 100%;"> FramFuel Feeds</h1>
        </a>
        ...
        <nav id="navbar" class=" navbar">
            <ul>
                ...
                <li class=" m-0"><a class="get-a-quote" href="{{route('profile')}}"><span>{{ auth()->user()->name }}</span> </a>
